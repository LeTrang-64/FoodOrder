    ...
    ----------------->
        ...
        <div class="content">
            ...
            <div class="content__menu">
                ...
                <%
                    ArrayList<Food> records = new FoodDAO().readData();
                    int leng = records.size() - 1;
                %>
                ...
                <%!
                    ...
                    /* đọc record bằng map */
                    public void read(Food record) {
                        try {

                            map.put("id", record.getFoodID() + "");
                            map.put("name", record.getFoodName());
                            map.put("price", record.getPrice() + "");
                            map.put("url", record.getImg());
                            map.put("des", record.getInfo());
                        } catch (Exception e) {
                            System.out.println("Loi load food list");
                        }
                    }
                %>
                    ...
                    <div>
                        <div class="img__container">
                            ...
                            <form action="addToCart" method="GET"> 
                                <div class="content__mask"><button type="submit" name="submit" value="<%= map.get("id")%>" style="cursor: pointer; width: 100%; height: 100%;background-color: transparent; border: none; outline: none"><i class="fas fa-cart-plus"></button></i></div>
                        </form>
                            	<img src="<%= map.get("url")%>" alt="Pizza" width="250" height="250" style="border-radius: 50%;">             
                        </div>
