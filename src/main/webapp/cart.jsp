...
<%@page import="org.trang.test.dao.FoodDAO"%>
<%@page import="java.util.HashMap"%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@ page import="org.trang.test.model.User"%>
<%@ page import="org.trang.test.model.User_food"%>
<%@page import="java.util.ArrayList"%>
<%@ page import="org.trang.test.model.Food"%>
<!DOCTYPE html>
...
<link
	href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,700"
	rel="stylesheet">
<link
...
%>
<%
	ArrayList<User_food> records = new FoodDAO().cart(user.getUser_id());
...
<%!Map<String, String> map = new HashMap<String, String>();
	...
	/* đọc record bằng map */
	public void read(User_food record) {
		Food food = new FoodDAO().loadFoodInfo(record.getFood_id());
		map.put("id", food.getFoodID() + "");
		map.put("name", food.getFoodName());
		map.put("price", food.getPrice() + "");
		map.put("url", food.getImg());
		map.put("des", food.getInfo());
...
<body>
						...
						<tr class="vincent_cart_item">
							...
							<td>
								<form action="DeleteItemServlet" method="get">
									<button type="submit" name="submit" value="<%=map.get("id")%>"
										style="background-color: transparent; outline: none; border: none; color: white">x</button>
								</form>
							</td>
							<td class="vincent_product-thumbnail"><a href=""> <img
									src="<%=map.get("url")%> " alt="">
							</a></td>
							<td class="vincent_product-name" data-title="Product"><a
								href=""><%=map.get("name")%></a></td>
							<td class="vincent_product-price" data-title="Price"><span>$<%=map.get("price")%></span>
							</td>
							<td class="vincent_product-quantity" data-title="Quantity">
								<input type="text" value="<%=map.get("quantity")%>"
								name="quantity" class="vincent_quantity">
							</td>
							<td class="vincent_product-subtotal" data-title="Total"><span>$<%
				...
				<div class="vincent_cart_totals">
					...
					<form action="PayServlet" method="post">
						<button id="vincent_button vincent_button_background"
							...
							style="padding: 0.5rem 2rem; background-color: orange; border: none; outline: none; border-radius: 3px; font-family: 'Open Sans'; font-size: 1.5rem">
			...
			<div class="container_right">
				<form class="container_right-input">
					<input type="text" placeholder="search..."> <span
						class="icon"> <i class="fa fa-search" aria-hidden="true"></i>
					</span>
				</form>
	...
	<footer>
		<div class="footer__mid">
			...
			<div class="footer__icon">
				<a href="" class="footer__link"> <i class="fab fa-facebook-f"></i>
				</a> <a href="" class="footer__link"><i class="fab fa-twitter"></i></a>
		...
		<div id="mask">
			<div class="mask__wrapper">
				<div class="mask__title">
					<span>menu</span> <i class="fas fa-times" id="close-menu"></i>
				</div>
				<ul class="mask__menu">
	...
	<script>
		let pay = document
				.getElementById("vincent_button vincent_button_background");
