...
menu.onclick = () => { document.querySelector('.content__menu').scrollIntoView({ behavior: 'smooth' }); }
features.onclick = () => { document.querySelector('.content__intro').scrollIntoView({ behavior: 'smooth' }); }
about.onclick = () => { document.querySelector('.about').scrollIntoView({ behavior: 'smooth' }); }
contact.onclick = () => { document.querySelector('.contact').scrollIntoView({ behavior: 'smooth' }); }
